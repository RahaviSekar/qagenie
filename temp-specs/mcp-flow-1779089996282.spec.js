...
/**
 * Helper function to wait for the storefront to be ready after initial page load,
 * often used to pass Cloudflare/bot checks by waiting for a key element.
...
test("Add to Cart — happy path", async ({ page }) => {
    ...
    // No waitForLoadState('domcontentloaded') here, as 'Add to Cart' often uses AJAX
    // and doesn't cause a full page reload, but rather an in-page update like a flyout.
